(function () {
  ...
  const ruText = {
    ...
    'Дыбыстар': 'Звуки',
    'Дауыс': 'Голос',
    'Дауыс созу': 'Протягивание голоса',
    '🚂 Дауыс созу': '🚂 Протягивание голоса',
    'Дауыспен жумыс': 'Работа с голосом',
    'Дауыспен жұмыс': 'Работа с голосом',
    ...
    'Техника дыбыстары': 'Звуки техники',
    'Эмоция': 'Эмоции',
    'С-Ш': 'С-Ш',
    ...
    'Музыкалық ырғақ': 'Музыкальный ритм',
    ...
    'Дыбысты тыңдап, эмоцияны немесе әрекетті анықтаңыз!': 'Послушайте звук и определите эмоцию или действие!',
    ...
    'Техниканың дыбысын тыңдап, оны табыңыз!': 'Послушайте звук техники и найдите её!',
    ...
    'Біз бірге оқимыз және жазамыз.': 'Мы вместе читаем и пишем.',
    'Етістік': 'Глагол',
    'Суретке басып тыңдаймыз және карточкаларды дұрыс ретке қоямыз.': 'Нажимаем на картинку, слушаем и ставим карточки в правильном порядке.',
    '1-тапсырма': '1-задание',
    '2-тапсырма': '2-задание',
    'Пиктограмманы басып, оның атауын тыңдаңыз.': 'Нажмите на пиктограмму и послушайте её название.',
    'Алдымен Ойнау батырмасын басып, дыбысты тыңдаңыз.': 'Сначала нажмите кнопку «Играть» и послушайте звук.',
    'Ойнау': 'Играть',
    'Келесі': 'Далее',
    'Тыңдау': 'Слушать',
    'Беттегі пиктограммалар кезекпен оқылып жатыр.': 'Пиктограммы на странице читаются по очереди.',
    '1-бет ашылды.': 'Открыта 1-я страница.',
    '2-бет ашылды.': 'Открыта 2-я страница.',
    'Пиктограмманы таңдаңыз.': 'Выберите пиктограмму.',
    '1-сөз': '1-е слово',
    '2-сөз': '2-е слово',
    '3-сөз': '3-е слово',
    'Дайын': 'Готово',
    'Алып тастау': 'Убрать',
    'Тыңдаңыз:': 'Слушайте:',
    'Енді карточкаларды дұрыс ретпен қойыңыз.': 'Теперь поставьте карточки в правильном порядке.',
    'Қате. Қайта тыңдау үшін Ойнау батырмасын басыңыз.': 'Ошибка. Чтобы послушать снова, нажмите кнопку «Играть».',
    'Дұрыс! Керемет орналастырдыңыз.': 'Правильно! Отлично расположили.',
    'тыңдалып жатыр.': 'идёт прослушивание.',
    'Бұл:': 'Это:',
    'Бұл -': 'Это -',
    'Бала доп тепті': 'Мальчик пнул мяч',
    'Мысық сүт ішті': 'Кошка пьет молоко',
    'Қол жуды': 'Помыл руки',
    'Тамақ ішті': 'Ел',
    'Ойнады': 'Играл',
    'Сабақ оқыды, кітап оқыды': 'Занимался, читал книгу',
    'Ұйықтады': 'Спал',
    'Оянды': 'Проснулся',
    'Доп ойнады': 'Играл в мяч',
    'Құрастырды': 'Собирал',
    'Теледидар көрді': 'Смотрел телевизор',
    'Суға түсті': 'Плавал',
    'Қоқыс тастады': 'Выбросил мусор',
    'Сыпырды': 'Подметал',
    'Доп': 'Мяч',
    'Тепті': 'Пнул',
    'Сүт': 'Молоко',
    ...
    'Сөз немесе сөйлем енгізіңіз…': 'Введите слово или предложение…',
    'БУЫН': 'СЛОГ',
    'СӨЗ': 'СЛОВО',
    'СӨЗ НЕМЕСЕ СӨЙЛЕМ': 'СЛОВО ИЛИ ПРЕДЛОЖЕНИЕ',
    '👁️ Көрсету': '👁️ Показать',
    '🎧 Тыңдау': '🎧 Слушать',
    '✨ Құрастыру': '✨ Составить',
    '⏹ Тоқтату': '⏹ Остановить',
    '⏳ ЖИ құрап жатыр...': '⏳ ИИ составляет...',
    'ЖИ сөйлемдер құрап жатыр...': 'ИИ составляет предложения...',
    'ЖИ дайын. Сөйлем пирамидасы құрастырылды.': 'ИИ готов. Пирамида предложения составлена.',
    'ЖИ сөйлем құра алмады. Толық сөйлемді өзіңіз енгізіп көріңіз.': 'ИИ не смог составить предложение. Попробуйте ввести полное предложение.',
    ...
    'Тақырып / Тема': 'Тема',
    'Тіл / Язык': 'Язык',
    'Админ: ЖИ батырмалары': 'Админ: кнопки ИИ',
    'ЖИ-Логопед': 'ИИ-логопед',
    'ЖИ Сөйлеуді бағалау': 'ИИ оценка речи',
    'ЖИ': 'ИИ',
    'Сіздің ақылды көмекшіңіз': 'Ваш умный помощник',
    'Сәлеметсіз бе! Мен сіздің ЖИ көмекшіңізбін. Қандай сұрақтарыңыз бар? (Здравствуйте! Я ваш ИИ-помощник. Какие у вас есть вопросы?)': 'Здравствуйте! Я ваш ИИ-помощник. Какие у вас есть вопросы?',
    'Сұрақ қойыңыз... (Задайте вопрос...)': 'Задайте вопрос...',
    'Сөздерді анық айтыңыз': 'Произносите слова чётко',
    ...
    'Алдымен сөзді тыңдаңыз!': 'Сначала послушайте слово!',
    ...
    'ЖАЙ 🗣️': 'ОБЫЧНО 🗣️',
    'СЫБЫРЛАП 🤫': 'ШЁПОТОМ 🤫',
    'Қатты айт!': 'Говори громко!',
    'Жай айт!': 'Говори обычным голосом!',
    'Сыбырла!': 'Шепчи!',
    'Дауыстап, қатты және батыл айтыңыз!': 'Говорите громко, уверенно и смело!',
    'Громко, қатты және батыл айтыңыз!': 'Говорите громко, уверенно и смело!',
    'Дауыстап айт — қатты, батыл дауыспен!': 'Скажите громко — сильным и уверенным голосом!',
    'Громко айт — қатты, батыл дауыспен!': 'Скажите громко — сильным и уверенным голосом!',
    'Жай, қалыпты дауыспен айтыңыз!': 'Говорите обычным, спокойным голосом!',
    'Обычно, қалыпты дауыспен айтыңыз!': 'Говорите обычным, спокойным голосом!',
    'Жай айт — қалыпты, мысалы телефонда!': 'Скажите обычным голосом, как по телефону!',
    'Обычно айт — қалыпты, мысалы телефонда!': 'Скажите обычным голосом, как по телефону!',
    'Сыбырлап, ақырын айтыңыз!': 'Говорите шепотом, тихо!',
    'Шёпотом, ақырын айтыңыз!': 'Говорите шепотом, тихо!',
    'Сыбырлап айт — тым ақырын, бірақ анық!': 'Скажите шепотом — тихо, но четко!',
    'Шёпотом айт — тым ақырын, бірақ анық!': 'Скажите шепотом — тихо, но четко!',
    'Дауыстар тізбегі': 'Цепочка голосов',
    '🔗 Дауыстар тізбегі': '🔗 Цепочка голосов',
    'Суретке тиіп, дыбысты қайталаңыз!': 'Нажмите на картинку и повторите звук!',
    'Дыбыстарды тиістілікпен қайталаңыз!': 'Повторяйте звуки правильно!',
    '🎤 Дыбыстарды тиістілікпен қайталаңыз!': '🎤 Повторяйте звуки правильно!',
    'Са-бақ': 'У-рок',
    'Қа-лам': 'Руч-ка',
    'Қо-ян': 'За-яц',
    ...
    'Мен сурет салдым': 'Я нарисовал картинку',
    'Аю — топ-топ': 'Медведь — топ-топ',
    'Мысық — мияу': 'Кошка — мяу',
    'Бақа — бақ-бақ': 'Лягушка — ква-ква',
    'Ит — Аф-Аф': 'Собака — гав-гав',
    'Мен мектепке барамын.': 'Я иду в школу.',
    'Мектепте достарыммен ойнаймын.': 'В школе я играю с друзьями.',
    '🔊 Тыңда': '🔊 Слушать',
  ...
  const dictionaryEntryCache = new WeakMap();
  ...
  function getDictionaryEntries(dict) {
    if (dictionaryEntryCache.has(dict)) return dictionaryEntryCache.get(dict);

    const entries = Object.entries(dict)
      .filter(([source, target]) => source && target && source !== target && normalizeText(source).length > 2)
      .sort((a, b) => normalizeText(b[0]).length - normalizeText(a[0]).length);

    dictionaryEntryCache.set(dict, entries);
    return entries;
  }

  function splitDecorations(text) {
    let core = String(text || '');
    let leading = '';
    let trailing = '';

    const leadingMatch = core.match(/^((?:\s|[\u200d\ufe0f]|\p{Extended_Pictographic})+)(.+)$/u);
    if (leadingMatch) {
      leading = leadingMatch[1];
      core = leadingMatch[2];
    }

    const trailingMatch = core.match(/^(.+?)((?:\s|[\u200d\ufe0f]|\p{Extended_Pictographic})+)$/u);
    if (trailingMatch) {
  ...
  function replaceKnownFragments(value, dict) {
    let result = value;
    ...
    getDictionaryEntries(dict).forEach(([source, target]) => {
      ...
      const pattern = [
        sourceStartsWithWord ? '(^|[^\\p{L}\\p{N}])' : '',
        escapeRegExp(normalizedSource),
        sourceEndsWithWord ? '(?=$|[^\\p{L}\\p{N}])' : ''
      ].join('');
      const regex = new RegExp(pattern, 'gu');

      result = result.replace(regex, (...args) => {
        const match = args[0];
        const prefix = sourceStartsWithWord ? args[1] || '' : '';
        return prefix + normalizedTarget + match.slice(prefix.length + normalizedSource.length);
      });
    });
  ...
  function translateString(value, lang) {
    ...
    if (cache.has(normalized)) return applyWhitespace(value, cache.get(normalized));

    let translated = dict[normalized];

    if (!translated) {
      const decorated = splitDecorations(normalized);
      const coreTranslated = dict[decorated.core];
      if (coreTranslated) {
        translated = decorated.leading + coreTranslated + decorated.trailing;
      }
    }

    if (!translated) {
      translated = replaceKnownFragments(normalized, dict);
    }

    if (translated) {
      cache.set(normalized, translated);
      return applyWhitespace(value, translated);
    }
  ...
  window.translateProfileText = function translateProfileText(value, lang) {
    return translateString(value, normalizeLang(lang || getProfileLang()));
  };
